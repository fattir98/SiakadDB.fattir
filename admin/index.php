 <?php
session_start();
if (!isset($_SESSION['isLogin']) || $_SESSION['isLogin'] != true || $_SESSION['level'] != "admin") {
...
?>
 ...
 <body class="sidebar-expand-lg sidebar-open bg-body-tertiary">
   ...
   <div class="app-wrapper">
           ...
           <li class="nav-item dropdown user-menu">
             ...
             <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
               ...
               <li class="user-body">
                 <!--begin::Row-->
                 <div class="row">
                   <div class="col-4 text-center"><a href="#">Follow</a></div>
     ...
     <!--end::Header-->
     <!--begin::Sidebar-->
     <aside class="app-sidebar bg-danger subtle-
       shadow" data-bs-theme="dark">
       <!--begin::Sidebar Brand-->
       <div class="sidebar-brand">
         <!--begin::Brand Link-->
         <a href="../assets/img/AdminLTElogo.png" class="brand-link">
           <!--begin::Brand Image-->
           <!--end::Brand Image-->
           <!--begin::Brand Text-->
           <span class="brand-text fw-light">Siakad UinSaizu</span>
           <!--end::Brand Text-->
         </a>
         <!--end::Brand Link-->
       </div>
         ...
         <nav class="mt-2">
           ...
           <ul
             ...
             <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
               ...
               <!-- <li class="nav-item">
                 <a href="./?p=tambahmahasiswa" class="nav-link">
                   <i class="nav-icon bi bi-circle-fill"></i>
